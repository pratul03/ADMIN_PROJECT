...
import {TbDashboard,
        TbFileUpload} from 'react-icons/tb';
import {VscGraphLine} from 'react-icons/vsc';
import {AiOutlineUsergroupAdd,
        AiOutlineDollarCircle,
        AiOutlineUserSwitch} from 'react-icons/ai';
import {MdNotificationsActive, 
        MdSwapHoriz} from 'react-icons/md'
...
const Navigation = () => {
  ...
  return <div className={`navigation ${nav && "active"} ${DarkTheme && "dark"}`}>
    ...
    <header>
      <div className="profile">
        <img src="https://t4.ftcdn.net/jpg/05/56/62/65/360_F_556626587_NYmwKW2MRnrLQn6jSybCYhR6rdwcWIXl.jpg" alt="user image" className="profile-img" />
      </div>
      <span>{username}</span>
    </header>
    ...
    <Nav  Icon={MdNotificationsActive} title={"Notifications"} />
    ...
    <Nav  Icon={MdSwapHoriz} title={`${DarkTheme ? "Switch to Light theme" : "Switch to Dark Theme"}`} onClick = {changeTheme} />
